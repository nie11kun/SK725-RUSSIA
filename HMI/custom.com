...
HS7=($85000,se3) ;Access level 7, visible	"汉江界面"	
PRESS(HS7)   
...
//M(Mask7/$85007/"panel_2_0_eng.png"/)
	...
	DEF CAOGESHU=(I/0,100//$85109,$85109,,/WR2//"/NC/_N_NC_GD3_ACX/INI[117]"/360,100,202/460,100,60/);环形槽个数
	DEF YOUDUAN=(R/-2000,2000//$85110,$85110,,/WR2//"/NC/_N_NC_GD3_ACX/INI[3]"/360,130,202/460,130,60/);工件右端
	DEF GRIND_SAFE=(R/-500,500//$85111,$85111,,/WR2//"/NC/_N_NC_GD3_ACX/PROCESS[17]"/360,160,202/460,160,60/);磨削安全位置
	DEF X_QUIT=(R/-500,500//$85112,$85112,,/WR2//"$R[12]"/360,190,202/460,190,60/);退刀位置
	DEF ZUIDU=(R/-10,10//$85113,$85113,,/WR2//"/NC/_N_NC_GD3_ACX/INI[15]"/360,220,202/460,220,60/);锥度
	DEF DANGQIANJIECHU=(R///$85114,$85114,,/WR2//"/NC/_N_NC_GD3_ACX/PROCESS[5]"/360,260,202/460,260,60/);当前磨削接触位
	DEF WHELL_POS_INI=(R///$85115,$85115,,/WR2//"/NC/_N_NC_GD3_ACX/PROCESS[14]"/360,290,202/460,290,60/);初始磨削接触位(对刀完成后磨削接触位)
